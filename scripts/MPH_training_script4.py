"""
MPH_training_script3.py

Training script for the Mirage Correction Model (MPH) using actual .npz data.
This final version fixes the TypeError caused by returning 'None' values.
...
class SyntheticTurbulenceDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # --- FIX APPLIED HERE ---
        # Removed 'tilt_flow': None to resolve the TypeError in DataLoader
    ...
    def train(self):
        ...
        for epoch in range(cfg.epochs):
            ...
            for batch_idx, sample in enumerate(self.train_loader):
                ...
                # tilt_flow entry is no longer expected in the sample dictionary
                # tilt_flow = sample.get('tilt_flow', None) 
                
                # The trainer still needs to handle the possibility of tilt_flow if you re-add it later.
                # For now, we proceed assuming it's not present in the sample.
                ...
                with autocast(enabled=not cfg.disable_amp):
                    ...
                    # loss_tilt calculation remains zero since tilt_flow is not passed/used
